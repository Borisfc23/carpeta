...
<body>
    ...
    <div class="contenedor-login">              
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="form-caja" method="POST" onsubmit="return validar()">
            ...
            <div id="registro" class="input-group">            
                <?php include("../Siete Sopas/ConexionesBD/validar-registro.php");?>
                <input type="email" class="input-field" placeholder="Ingrese Correo"  name="correo" id="correo">
                <input type="text" class="input-field" placeholder="Nombre de Usuario"  name="usuario" id="usuario">
                <input type="password" class="input-field" placeholder="Contraseña"  name="contraseña" id="contraseña">
                <input type="checkbox" class="check-box-terminos"><span>Acepta Terminos y Condiciones</span>
                <input type="submit" class="submit-btn" value="Registrar" name="submit">                
                <div class="register">
