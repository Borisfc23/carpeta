...
<head>
    ...
    <title>Para Tenedores - Siete Sopas</title>
    ...
    <nav id="nv-s" class="navbar navbar-expand-lg navbar-dark" style="background: rgba(28, 35, 49,0.9);">
      ...
      <main>
        <div class="contenedor-titulo">
            <h1>Para Tenedores</h1>       
            <h2>Broaster, lomo y más</h2>     
        </div>        
        <div class="contenedor-grid">
            <div class="grid-item">
                <div class="contenedor-img">
                    <img src="https://cdn.rusticadelivery.com/images/products/252/252-1598141689-5f41b4f9708d6.jpeg" alt="">        
                </div>      
                <div class="contenedor-texto">          
                    <h3>Poker en Salsa de Carne</h3>
            ...
            <div class="grid-item">
                <div class="contenedor-img">
                    <img src="Imagenes/ImgMenu/lomoSaltado.png" alt="">        
                </div>      
                <div class="contenedor-texto">          
                    <h3>Lomo Saltado</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis, ad.</p>     
            ...
            <div class="grid-item">
                <div class="contenedor-img">
                    <img src="Imagenes/ImgMenu/polloBroaster.png" alt="">        
                </div>               
                <div class="contenedor-texto">                 
            ...
            <div class="grid-item">
                <div class="contenedor-img">
                    <img src="https://cdn.rusticadelivery.com/images/products/57/57-01588011949.jpg" alt="">        
                </div>    
                <div class="contenedor-texto">              
                    <h3>Piqueos Rustico</h3>                              
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis, ad.</p>     
                    <hr>                               
                    <div class="contenedor-precio">
