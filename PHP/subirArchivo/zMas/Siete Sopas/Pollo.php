...
<head>
    ...
    <title>Pollos - Siete Sopas</title>
    ...
    <nav id="nv-s" class="navbar navbar-expand-lg navbar-dark" style="background: rgba(28, 35, 49,0.9);">
      ...
      <main>
        <div class="contenedor-titulo">
            <h1>Pollos</h1>       
            <h2>A la brasa, con chaufa o filete</h2>     
        </div>        
        <div class="contenedor-grid">
            <div class="grid-item">
                <div class="contenedor-img">
                    <img src="Imagenes/ImgDelivery/ImgPollo/cuartopollo.jpg" alt="">        
                </div>      
            ...
            <div class="grid-item">
                <div class="contenedor-img">
                    <img src="Imagenes/ImgDelivery/ImgPollo/polloentero.jpg" alt="">      
                </div>      
                <div class="contenedor-texto">          
                    <h3>Pollo a la Brasa</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis, ad.</p>     
            ...
            <div class="grid-item">
                <div class="contenedor-img">
                    <img src="Imagenes/ImgDelivery/ImgPollo/pollochaufa.jpg" alt="">      
                </div>               
                <div class="contenedor-texto">                 
                    <h3>Pollo + Chaufa</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis, ad.</p>    
            ...
            <div class="grid-item">
                <div class="contenedor-img">
                <img src="Imagenes/ImgDelivery/ImgPollo/fileterustico.jpg" alt="">     
                </div>    
                <div class="contenedor-texto">              
                    <h3>Filete Rustico</h3>                              
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis, ad.</p>     
                    <hr>                               
                    <div class="contenedor-precio">
