...
<head>
    ...
    <title>Pastas - Siete Sopas</title>
    ...
    <nav id="nv-s" class="navbar navbar-expand-lg navbar-dark" style="background: rgba(28, 35, 49,0.9);">
      ...
      <main>
        <div class="contenedor-titulo">
            <h1>Pastas</h1>       
            <h2>Con champiñones, lomo y mas</h2>     
        </div>        
        <div class="contenedor-grid">
            <div class="grid-item">
                <div class="contenedor-img">
                    <img src="https://cdn.rusticadelivery.com/images/products/26/26-1588567130-5eaf9c5a18ad0.jpg" alt="">        
                </div>      
                <div class="contenedor-texto">          
                    <h3>Fettucini al Alfredo</h3>
            ...
            <div class="grid-item">
                <div class="contenedor-img">
                    <img src="Imagenes/ImgMenu/fettuciniChampiñones.jpg" alt="">        
                </div>      
                <div class="contenedor-texto">          
                    <h3>Fettucini con Champiñones</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis, ad.</p>     
                    <hr>                               
                    <div class="contenedor-precio">
            ...
            <div class="grid-item">
                <div class="contenedor-img">
                    <img src="Imagenes/ImgMenu/fettuciniHuancaina.jpg" alt="">        
                </div>               
                <div class="contenedor-texto">                 
                    <h3>Fettucini con Lomo</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis, ad.</p>    
                    <hr>                                
                    <div class="contenedor-precio">
            ...
            <div class="grid-item">
                <div class="contenedor-img">
                    <img src="Imagenes/ImgMenu/fettuciniVerde.jpg" alt="">        
                </div>    
                <div class="contenedor-texto">              
                    <h3>Fettucini Verde</h3>                              
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis, ad.</p>     
                    <hr>                               
                    <div class="contenedor-precio">
